...
namespace SalesTerritoryApi.Validators
{
    ...
    static partial class UpdateTerritoryDtoValidationExtensions
    {
        public static IRuleBuilder<UpdateTerritoryDto, Dictionary<string, object>> ValidateDemographics(this IRuleBuilder<UpdateTerritoryDto, Dictionary<string, object>> builder)
        {
